...
ref_file="reference/RaTG13/MN996532.1_sequence.fasta.txt"
...
t_utr_seq = ref[[1]][t_utr_start:length(ref[[1]])]
...
t_utr_sites = sites[end > t_utr_start]
...
f_utr_sites = sites[end > f_utr_end]
