...
We decided to focus on genes differentially expressed (DE) upon SARS-CoV-2 infection, whether detected in NHBE or in A549 cells. Fig. 3 shows the number of genes DE detected from each of the methods used: DESeq2 (Love et al., 2014), edgeR (Robinson et al., 2010) and limma-voom (Law et al., 2014); for details, see the Methods section). 
